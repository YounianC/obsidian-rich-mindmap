...
- The pure-function layer (parsing, serialization, marks, notes, collapse state, tree operations, layout, camera, i18n) has 447 automated tests, including Markdown round-trip property tests and adversarial-input tests.
