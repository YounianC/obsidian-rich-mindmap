...
- The pure-function layer (parsing, serialization, marks, notes, collapse state, tree operations, layout, camera, i18n) is covered by automated tests throughout, including Markdown round-trip property tests and adversarial-input tests.
